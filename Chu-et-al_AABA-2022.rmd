...
knitr::opts_chunk$set(echo = TRUE, warning=FALSE, fig.path='figures/', fig.ext='png', dpi=300)
```
...
### Slide 20
```{r multivariate_p-accuracy, fig.width=10, fig.height=8}
...
## Slide 21
```{r multivariate_ranges, fig.width=10, fig.height=8}
